...
# This test drives a session that must be RUNNING — it types into it and waits for an
# answer. It deliberately does not start one: creating and destroying real sessions
